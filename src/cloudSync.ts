...
// from main.ts, gated on the Learner/parent turning sync on. That's
// what keeps Firebase's SDK out of the bundle for anyone who
...
// scanned Profile ID exists before committing to it.
...
// before the first-ever Attempt). Both are handled fine by a plain
...
// promise only resolves once the backend acknowledges it, not
